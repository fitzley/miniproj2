...
# plot linear model
p_dia_hard <- ggplot(chicago_map, aes(x = diabetes_rate, y = hard_index,
                                    color = residual,
                                    text = paste0("<b>", community, "</b><br>",
  ...
  scale_color_gradient2(low = "#48bea1", mid = "#f4bb8f", high = "#7b4419",
                        midpoint = 0) +
  theme_minimal() +
  labs(title = "Diabetes Prevalence Correlates with Socioeconomic Hardship",
       x = "Diabetes Rate",
       y = "Hardship Index")

# interactive scatterplot
ggplotly(p_dia_hard, tooltip = "text") %>%
  layout(autosize = TRUE) %>%
  config(displayModeBar = FALSE)
```
